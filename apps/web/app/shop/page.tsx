...
function ShopContent() {
  ...
  return (
    <Shell wide>
      ...
      <div className="lg:grid lg:grid-cols-[1.1fr_1fr] lg:gap-6 lg:items-start mb-8">
        <motion.div
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.3 }}
          className="bg-secondary text-white border-[3px] border-outline rounded-sticker p-6 shadow-[0_5px_0_0_#1A1A2E] mb-8 lg:mb-0"
        >
